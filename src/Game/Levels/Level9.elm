module Game.Levels.Level9 exposing (..)
...
generateGrid =
    [ { xy = ( 0, 0 ), status = NonSelected, item = Wall, dir = Nothing }
    , { xy = ( 0, 1 ), status = Current, item = Bomb, dir = Just [ Up, Down ] }
    ...
    , { xy = ( 1, 1 ), status = NonSelected, item = Duplicator, dir = Just [ Left ] }
    ...
    , { xy = ( 2, 1 ), status = NonSelected, item = Swap, dir = Just [ Down, Left ] }
    ...
    , { xy = ( 3, 5 ), status = NonSelected, item = Field, dir = Nothing }
    , { xy = ( 4, 0 ), status = NonSelected, item = Swap, dir = Just [ Up, Right ] }
    ...
    , { xy = ( 4, 5 ), status = NonSelected, item = Field, dir = Nothing }
    , { xy = ( 5, 0 ), status = NonSelected, item = Wall, dir = Nothing }
    , { xy = ( 5, 1 ), status = NonSelected, item = Bomb, dir = Just [ Right ] }
    , { xy = ( 5, 2 ), status = NonSelected, item = Stick, dir = Nothing }
    , { xy = ( 5, 3 ), status = NonSelected, item = Wall, dir = Nothing }
    , { xy = ( 5, 4 ), status = NonSelected, item = Wall, dir = Nothing }
    , { xy = ( 5, 5 ), status = NonSelected, item = Win, dir = Nothing }
    ]
